...
namespace RecruitX.Migrations
{
    ...
    [Migration("20250613063920_applicationfk")]
    partial class applicationfk
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecruitX.Models.ApplicationStatusHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("RecruitX.Models.EvaluationToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("evaluation_tokens", (string)null);
                });
            ...
            modelBuilder.Entity("RecruitX.Models.Interview", b =>
                {
                    ...
                    b.Property<List<string>>("InterviewersMail")
                        .HasColumnType("text[]");

                    b.Property<bool>("IsTechnicalRound")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("RecruitX.Models.InterviewPanel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("RecruitX.Models.InterviewerGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("interviewer_group", (string)null);
                });
            ...
            modelBuilder.Entity("RecruitX.Models.LeadToRecruiter", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasColumnName("Id");
                    ...
                    b.HasKey("Id", "RecruiterId");

                    b.HasIndex("RecruiterId");

                    b.ToTable("lead_to_recruiter", (string)null);
                });
            ...
            modelBuilder.Entity("RecruitX.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("RecruitX.Models.PanelEvaluationLink", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("PanelEvaluationLinks");
                });

            modelBuilder.Entity("RecruitX.Models.PanelEvaluationResponse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("PanelEvaluationLinkId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("PanelEvaluationLinkId");

                    b.ToTable("PanelEvaluationResponses");
                });

            modelBuilder.Entity("RecruitX.Models.PanelToGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("panel_to_group", (string)null);
                });
            ...
            modelBuilder.Entity("RecruitX.Models.EvaluationToken", b =>
                {
                    b.HasOne("RecruitX.Models.Interview", "Interview")
                        .WithOne()
                        .HasForeignKey("RecruitX.Models.EvaluationToken", "InterviewId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RecruitX.Models.PanelEvaluationResponse", b =>
                {
                    b.HasOne("RecruitX.Models.PanelEvaluationLink", "PanelEvaluationLink")
                        .WithMany()
                        .HasForeignKey("PanelEvaluationLinkId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PanelEvaluationLink");
                });
            ...
            modelBuilder.Entity("RecruitX.Models.PanelToGroup", b =>
                {
                    ...
                    b.HasOne("RecruitX.Models.InterviewerGroup", "Group")
