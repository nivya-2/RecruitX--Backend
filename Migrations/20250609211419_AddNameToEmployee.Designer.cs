...
namespace RecruitX.Migrations
{
    ...
    [Migration("20250609211419_AddNameToEmployee")]
    partial class AddNameToEmployee
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecruitX.Models.Application", b =>
                {
                    ...
                    b.HasOne("RecruitX.Models.User", "CreatedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("RecruitX.Models.ApplicationStatusHistory", b =>
                {
                    ...
                    b.HasOne("RecruitX.Models.User", "ChangedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("RecruitX.Models.EmailTemplate", b =>
                {
                    b.HasOne("RecruitX.Models.User", "Creator")
                        .WithMany()
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RecruitX.Models.LeadToRecruiter", b =>
                {
                    b.HasOne("RecruitX.Models.User", "Lead")
                        .WithMany()
                        .HasForeignKey("Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("RecruitX.Models.User", "Recruiter")
                        .WithMany()
            ...
            modelBuilder.Entity("RecruitX.Models.User", b =>
                {
                    b.HasOne("RecruitX.Models.Employee", "Employee")
                        .WithOne("User")
                        .HasForeignKey("RecruitX.Models.User", "EmployeeId")
                        .OnDelete(DeleteBehavior.Restrict);
